...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default double norm(Vector vector)
    {
        return norm(vector, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default double norm(Vector vector, java.util.Map<String, String> context)
    {
        return _iceI_normAsync(vector, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> normAsync(Vector vector)
    {
        return _iceI_normAsync(vector, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Double> normAsync(Vector vector, java.util.Map<String, String> context)
    {
        return _iceI_normAsync(vector, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> _iceI_normAsync(Vector iceP_vector, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Double> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "norm", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     Vector.ice_write(ostr, iceP_vector);
                 }, istr -> {
                     double ret;
                     ret = istr.readDouble();
                     return ret;
    ...
    default Vector addVectors(Vector[] vectors)
    {
        return addVectors(vectors, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default Vector addVectors(Vector[] vectors, java.util.Map<String, String> context)
    {
        return _iceI_addVectorsAsync(vectors, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Vector> addVectorsAsync(Vector[] vectors)
    {
        return _iceI_addVectorsAsync(vectors, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Vector> addVectorsAsync(Vector[] vectors, java.util.Map<String, String> context)
    {
        return _iceI_addVectorsAsync(vectors, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Vector> _iceI_addVectorsAsync(Vector[] iceP_vectors, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Vector> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "addVectors", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     Vectors2DHelper.write(ostr, iceP_vectors);
                 }, istr -> {
                     Vector ret;
                     ret = Vector.ice_read(istr);
                     return ret;
                 });
        return f;
    }
